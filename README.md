...
- [Configuring shading](#configuring-shading)
  ...
  - [shader-web-background API](#shader-web-background-api)
    ...
    - [Context attributes](#context-attributes)
      - [Context attribute: canvas](#context-attribute-canvas)
      - [Context attribute: width](#context-attribute-width)
      - [Context attribute: height](#context-attribute-height)
      - [Context attribute: cssPixelRatio](#context-attribute-csspixelratio)
      - [Context attribute: cssWidth](#context-attribute-csswidth)
      - [Context attribute: cssHeight](#context-attribute-cssheight)
      - [Context attribute: isOverShader](#context-attribute-isovershader)
      - [Context attribute: getCoordinateX](#context-attribute-getcoordinatex)
      - [Context attribute: getCoordinateY](#context-attribute-getcoordinatey)
      - [Context attribute: buffers](#context-attribute-buffers)
      - [Context attribute: texture](#context-attribute-texture)
      - [Context attribute: initHalfFloatRGBATexture](#context-attribute-inithalffloatrgbatexture)
